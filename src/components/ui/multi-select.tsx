    ...
    >
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn(
            "flex w-full p-1 rounded-md border-2 min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit",
            className,
          )}
        >
                ...
                {selectedValues.slice(0, maxCount).map((value) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <XCircle
                        className="ms-2 size-5 cursor-pointer"
                        onClick={(event) => {
          ...
          <CommandList>
            ...
            <CommandGroup>
              ...
              >
                ...
                <span>إختيار الكل</span>
              </CommandItem>
              {options.map((option) => {
                const optionValue = getOptionValue(option) as string;
