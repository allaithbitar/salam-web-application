...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "article_participation" ADD CONSTRAINT "article_participation_articleId_members_id_fk" FOREIGN KEY ("articleId") REFERENCES "public"."members"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
